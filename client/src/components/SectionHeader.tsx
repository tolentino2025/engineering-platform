    ...
    <ScrollReveal className={`mb-12 lg:mb-16 ${align === "center" ? "text-center max-w-3xl mx-auto" : ""}`}>
      {tag && (
        <div className="inline-flex items-center gap-2 mb-4">
          <span className="w-8 h-px bg-[oklch(0.32_0_0)] dark:bg-[oklch(0.58_0.22_25)]" />
          <span className="font-mono text-xs uppercase tracking-widest text-[oklch(0.32_0_0)] dark:text-[oklch(0.58_0.22_25)]">{tag}</span>
          <span className="w-8 h-px bg-[oklch(0.32_0_0)] dark:bg-[oklch(0.58_0.22_25)]" />
        </div>
      )}
